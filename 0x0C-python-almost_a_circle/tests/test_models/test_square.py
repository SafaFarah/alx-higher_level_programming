...
class TestSquare(unittest.TestCase):
    ...
    def test_num_args(self):
        ...
        with self.assertRaises(TypeError) as e:
            s5 = Square()
        exp1 = "Square.__init__() missing 1 required positional arguments: 'size'"
        self.assertEqual(str(e.exception), exp1)
        with self.assertRaises(TypeError) as e:
            s6 = Square(3, 2, 5, 9, 8)
        exp2 = "Square.__init__() takes from 2 to 5 positional arguments but 6 were given"
    ...
    def test_to_dictionary(self):
        ...
        self.assertEqual(self.s3.to_dictionary(), {'id': 12, 'x': 0, 'size': 8, 'y': 0})
